...
class TVariableFKGuide(guide.TGuideBaseComponent):
    def __init__(self, guide_name='', guide_side='C', guide_index=0, num_divisions=4, num_ctrls=4, fromDagNode=0):
        guide.TGuideBaseComponent.__init__(self, guide_name, 'variableFK', guide_side, guide_index,
...
def instantiateFromDagNode(dagNode):
    return TVariableFKGuide(dagNode.guide_name.get(),
...
def buildGuide(**kwargs):
    return TVariableFKGuide(**kwargs)
