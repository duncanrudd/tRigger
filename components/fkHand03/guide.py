...
class TFkHand03Guide(guide.TGuideBaseComponent):
    def __init__(self, guide_name='', guide_side='C', guide_index=0, num_segments=5, num_digits=4, thumb=1, fromDagNode=0):
        guide.TGuideBaseComponent.__init__(self, guide_name, 'fkHand03', guide_side, guide_index, fromDagNode=fromDagNode)
...
def instantiateFromDagNode(dagNode):
    return TFkHand03Guide(dagNode.guide_name.get(),
