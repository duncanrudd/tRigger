...
class TLimbIkFkGuide(guide.TGuideBaseComponent):
    def __init__(self, guide_name='', guide_side='C', guide_index=0, num_divisions=5, add_joint=1,
                 world_aligned_ik_ctrl=0, fromDagNode=0):
        guide.TGuideBaseComponent.__init__(self, guide_name, 'limbIkFk', guide_side, guide_index, fromDagNode=fromDagNode)
        for param in ['num_divisions', 'add_joint', 'world_aligned_ik_ctrl']:
...
def instantiateFromDagNode(dagNode):
    return TLimbIkFkGuide(dagNode.guide_name.get(),
