...
class TMouth02(components.TBaseComponent):
    ...
    def addObjects(self, guide):
        ...
        for i in range(guide.num_divisions):
            ...
            srt = dag.addChild(self.local_srt, 'group', name=self.getName('upper_align_%s_srt' % num))
            ...
            if 0 < i < guide.num_divisions-1:
                ...
                srt = dag.addChild(self.local_srt, 'group', name=self.getName('lower_align_%s_srt' % num))
