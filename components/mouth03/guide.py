...
class TMouth03Guide(guide.TGuideBaseComponent):
    def __init__(self, guide_name='', guide_side='C', guide_index=0, num_divisions=8, num_ctrls=1, corner_start=.25,
        ...
        guide.TGuideBaseComponent.__init__(self, guide_name, 'mouth03', guide_side, guide_index,
...
def instantiateFromDagNode(dagNode):
    return TMouth03Guide(dagNode.guide_name.get(),
