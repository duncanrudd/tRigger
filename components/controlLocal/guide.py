...
class TControlLocalGuide(guide.TGuideBaseComponent):
    def __init__(self, guide_name='', guide_side='C', guide_index=0, num_ctrls=3, add_joint=1, fromDagNode=0):
        guide.TGuideBaseComponent.__init__(self, guide_name, 'controlLocal', guide_side, guide_index, fromDagNode=fromDagNode)
...
def instantiateFromDagNode(dagNode):
    return TControlLocalGuide(dagNode.guide_name.get(),
...
def buildGuide(**kwargs):
    return TControlLocalGuide(**kwargs)
