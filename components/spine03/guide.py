...
class TSpine03Guide(guide.TGuideBaseComponent):
    def __init__(self, guide_name='', guide_side='C', guide_index=0, num_divisions=4, num_ctrls=4, fromDagNode=0):
        guide.TGuideBaseComponent.__init__(self, guide_name, 'spine03', guide_side, guide_index,
...
def instantiateFromDagNode(dagNode):
    return TSpine03Guide(dagNode.guide_name.get(),
